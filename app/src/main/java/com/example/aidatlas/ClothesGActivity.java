...
public class ClothesGActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clothes_gactivity);
        ...
        builder.setMessage("Thanks for donating clothes!")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Intent intent = new Intent(ClothesGActivity.this, DonationDetailsActivity.class);
